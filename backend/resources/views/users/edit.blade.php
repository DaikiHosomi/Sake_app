            ...
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div class="py-5 form">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="name" class="col-md-6 form-control" id="exampleInputName" name="name" value="{{ $user->name }}">
                    </div>

                    {{-- <div class="form-group row">
                        <label class="col-md-5 col-form-label">ユーザー名</label>
                        <input type="text" class="col-md-7　form-control" value="{{ $user->name }}"name="name">
                    </div> --}}
                    ...
                    <div class="form-group row">
                        ...
                        <textarea type="text" class="col-md-6 form-control"　rows="2" id="exampleInputName" name="favorite_sake_name">
                    ...
                    <div class="form-group row">
                        ...
                        <textarea type="text" class="col-md-6 form-control" rows="4" id="exampleInputName" name="user_self_introduction">
